...
const std::string SendEvents::CHANGE_SOUND_CARD = "change-sound-card";
    const std::string SendEvents::CREATE_AUDIO_TRACK = "create-audio-track";
	const std::string SendEvents::SET_AUDIO_TRACK = "set-audio-track";
    const std::string SendEvents::CHANGE_AUDIO_TRACK = "change-audio-track";
    const std::string SendEvents::REMOVE_AUDIO_TRACK = "remove-audio-track";
    const std::string SendEvents::SEND_P2P_RESTART = "send-p2p-restart";
    const std::string SendEvents::SEND_P2P_OFFER = "send-p2p-offer";
    const std::string SendEvents::SEND_P2P_ANSWER = "send-p2p-answer";
    const std::string SendEvents::SEND_ICE_CANDIDATE = "send-ice-candidate";

    const std::string SendEvents::CREATE_STAGE = "create-stage";
    const std::string SendEvents::CHANGE_STAGE = "change-stage";
    const std::string SendEvents::REMOVE_STAGE = "remove-stage";

    const std::string SendEvents::CREATE_GROUP = "create-group";
    const std::string SendEvents::CHANGE_GROUP = "change-group";
    const std::string SendEvents::REMOVE_GROUP = "remove-group";

    const std::string SendEvents::JOIN_STAGE = "join-stage";
    const std::string SendEvents::LEAVE_STAGE = "leave-stage";
    const std::string SendEvents::LEAVE_STAGE_FOR_GOOD = "forget-stage";
