...
const std::string SendEvents::CREATE_LOCAL_AUDIO_TRACK = "create-local-audio-track";
const std::string SendEvents::CHANGE_LOCAL_AUDIO_TRACK = "create-local-audio-track";
const std::string SendEvents::REMOVE_LOCAL_AUDIO_TRACK = "remove-local-audio-track";
